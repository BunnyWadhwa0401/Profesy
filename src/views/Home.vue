...
<template>
  <main class="home-page">
    ...
    <div class="grid mt-20 gap-3">
      ...
      <router-link to="/product" v-for="order in orders" :key="order">
        <section
          ...
          <section class="flex gap-4 px-2">
            ...
            <svg v-show="order[3] == 'Handwork'" class="stroke-black" width="24" height="24" viewBox="0 0 24 24"
