...
onMounted(async () => {
  ...
  let randomProgress = function () { return randomNum(5, 95) }; // set the progress percentage here
  ...
  <main class="home-page">
    ...
    <div class="grid mt-20 gap-3">
      ...
      <section
        ...
        <section class="bg-primary/10 flex justify-center px-4 py-2 rounded-xl">To be delivered today</section>
      </section>
      <section
        class="tile grid grid-cols-[1fr_3fr_3fr_2fr_2fr_2fr] gap-6 bg-white rounded-[24px] w-full h-[5rem] px-8 shadow-lg shadow-grey/5 items-center">
        ...
        <section class="bg-primary/10 flex justify-center w-fit m-auto px-4 py-2 rounded-xl">To be delivered today
        </section>
      </section>
      <section
        class="tile grid grid-cols-[1fr_3fr_3fr_2fr_2fr_2fr] gap-6 bg-white rounded-[24px] w-full h-[5rem] px-8 shadow-lg shadow-grey/5 items-center">
        ...
        <section class="bg-primary/10 flex justify-center w-fit m-auto px-4 py-2 rounded-xl">Due Tomorrow</section>
      </section>
      <section
        class="tile grid grid-cols-[1fr_3fr_3fr_2fr_2fr_2fr] gap-6 bg-white rounded-[24px] w-full h-[5rem] px-8 shadow-lg shadow-grey/5 items-center">
      ...
      <section
        ...
        <section class="bg-primary/10 flex justify-center w-fit m-auto px-4 py-2 rounded-xl">Due Wednesday</section>
      </section>
    </div>
  </main>
</template>
