<template>
  <main class="home-page">
    <div class="flex justify-between">
      <section>
        <h1 class="font-heading text-4xl mb-0">Good Morning, Ginni !</h1>
        <h3 class="font-text font-normal text-base text-grey mt-0">
          30th February, Tuesday | 4 appointments
        </h3>
      </section>
    ...
    <div class="grid grid-rows-5 pt-5 gap-3">
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-sm items-center pr-10"
      >
