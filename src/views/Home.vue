...
onMounted(() => {
  const timeLine = gsap.timeline({
    Defaults: { Easing: "Expo.easeInOut", x: 0, y: 0 },
  });
  timeLine
    .fromTo("#welcome *",
      {
...
<template>
  <main class="home-page">
    ...
    <div id="progressContainer" class="grid grid-cols-3 w-full h-[14rem] gap-4 justify-between">
      <div class="bg-white mt-8 rounded-[32px] shadow-xl shadow-grey/5 grid grid-cols-2">
    ...
    <div class="flex justify-between mt-8">
      <section>
        <h1 class="font-heading text-4xl mb-0">Orders in Queue</h1>
      </section>
    ...
    <div class="grid grid-rows-5 pt-5 gap-3">
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-lg shadow-grey/5 items-center pr-10">
        ...
        <section class="flex justify-center font-heading">92%</section>
        <section class="flex justify-center">To be delivered today</section>
      </section>
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-lg shadow-grey/5 items-center pr-10">
        ...
        <section class="flex justify-center font-heading">83%</section>
        <section class="flex justify-center">To be delivered today</section>
      </section>
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-lg shadow-grey/5 items-center pr-10">
        ...
        <section class="flex justify-center font-heading">23%</section>
        <section class="flex justify-center">Due Tomorrow</section>
      </section>
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-lg shadow-grey/5 items-center pr-10">
        ...
        <section class="flex justify-center font-heading">30%</section>
        <section class="flex justify-center">Due tomorrow</section>
      </section>
      <section
        class="grid grid-cols-6 gap-6 bg-white rounded-[24px] w-full h-[5rem] shadow-lg shadow-grey/5 items-center pr-10">
        ...
        <section class="flex justify-center font-heading">95%</section>
        <section class="flex justify-center">Due Wednesday</section>
      </section>
    </div>
  </main>
</template>
